...
//var s_account="citicitimortsupport"
...
//s.linkInternalFilters="javascript:,citi.com"
s.linkInternalFilters="javascript:,citi.com,citibank.com,citicards.com,accountonline.com,citi.bridgetrack.com,accountonline.bridgetrack.com"
s.linkLeaveQueryString=false
//s.linkTrackVars="prop46,prop47,prop48,prop49,eVar6"
...
function s_doPlugins(s) {
	...
	if(!s.campaign) s.campaign=s.getQueryParam('cmp,emc')
		s.campaign =s.getValOnce(s.campaign,'s_cmp',0);
		
	if(!s.eVar39) s.eVar39=s.getQueryParam('intc')
	if(!s.eVar22) s.eVar22=s.getQueryParam('ProspectID')

	if ((s.prop47) && (!s.eVar6)) s.eVar6=s.prop47;
	
	s.eVar7=s.getPreviousValue(s.pageName,'gpv_p7','');
	
	s.prop64=s.getTimeParting('h','-5'); // Set hour 
	s.prop65=s.getTimeParting('d','-5'); // Set day
	s.prop66=s.prop65+"|"+s.prop64; //Set hour|day
...
/*
* Plugin: getTimeParting 2.0 Omniture Consulting
 */
...
s.visitorNamespace="citinaconsumer"
